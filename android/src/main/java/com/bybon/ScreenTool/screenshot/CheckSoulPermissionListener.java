package com.bybon.ScreenTool.screenshot;
...
/**
 * 对SoulPermission的回调监听器做一层封装，增加了申请权限时的弹窗提示
 * <pre>
 *     author  : Fantasy
 ...
 * </pre>
 */
public abstract class CheckSoulPermissionListener implements CheckRequestPermissionListener {
     ...
     */
    public CheckSoulPermissionListener(String rationaleMessage, Runnable retryRunnable) {
